...
public class UdpSubscriptionListener implements SubscriptionListener, Runnable {
    ...
    UdpSubscriptionListener(RedundantDatastore datastore, Notifier notifier, String udpAddress, int udpPort) throws UnknownHostException, IOException {
        this(datastore, notifier, "*", udpAddress, udpPort);
    }

    UdpSubscriptionListener(RedundantDatastore datastore, Notifier notifier, String nic, String updAddress, int udpPort) throws UnknownHostException, IOException {
